...
For example:
   VERBOSE=1 ./cookbook/install_master_slave
   VERBOSE=1 ./cookbook/install_all_masters
   VERBOSE=1 ./cookbook/install_fan_in
   VERBOSE=1 ./cookbook/install_star
...
Run:
DRYRUN=1 ./cookbook/install_$TOPOLOGY.sh
...
* thl
* replicator
For each one of the above, there is a corresponding ./cookbook/$TOOL_NAME

e.g.: ./cookbook/trepctl status
