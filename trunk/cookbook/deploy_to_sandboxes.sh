...
replace_text ./cookbook/USER_VALUES.sh '/var/lib/mysql' "$HOME/sandboxes/$SANDBOX_DIR/data" BACKUP
replace_text ./cookbook/USER_VALUES.sh '/etc/my.cnf' "$HOME/sandboxes/$SANDBOX_DIR/my.sandbox.cnf"
replace_text ./cookbook/USER_VALUES.sh 'DATABASE_PORT=3306' "DATABASE_PORT=$MYSQL_PORT"
